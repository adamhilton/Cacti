...
namespace Cacti.Web.Infrastructure.Data
{
    ...
    {
        private readonly CactiDbContext _ctx;
        private readonly UserManager<User> _userManager;
        private readonly IConfigurationRoot _configuration;
        private readonly ILogger<SeedData> _logger;

        public SeedData(CactiDbContext ctx,
        ...
        {
            var userName = _configuration.GetValue<string>("CACTI_ADMINUSER") ?? string.Empty;
            var password = _configuration.GetValue<string>("CACTI_ADMINPASS") ?? string.Empty;
